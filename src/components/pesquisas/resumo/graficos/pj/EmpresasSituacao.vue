...
<script>
  ...
  export default {
      ...
      return{
        dataGrafico: [
          { classediv: 'box-shadow', width: '100%', height: '400', type: 'bar2d', dataFormat: 'json',
            dataSource: {
              "chart": {
                "caption": "Quantidade de empresas por situação cadastral",
                "plottooltext": "<div id='nameDiv'><b>Situação cadastral: </b>$label</b><b><br>Número de empresas: </b>$value<br/></div>",
    ...
    watch: {
      dadosDosGraficos(){
        this.setDataGrafico(this.dadosDosGraficos.situacaoCadastral)
      }
    }
  }
</script>
